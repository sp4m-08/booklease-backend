            ...
            <tbody>
              {booksLoading ? (
                ...
                <tr key={book.id} className="border-b-2 border-gray-300 font-medium">
                  ...
                  <td className="p-4">{formatStudentName(book.uploader?.username, `User #${book.uploaded_by}`)}</td>
            ...
            <tbody>
              {notesLoading ? (
                ...
                <tr key={note.id} className="border-b-2 border-gray-300 font-medium">
                  ...
                  <td className="p-4">{formatStudentName(note.uploader?.username, `User #${note.uploaded_by}`)}</td>
                  <td className="p-4 text-right">
                    <button 
                      onClick={() => {
